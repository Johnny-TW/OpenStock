...
export function* fetchApi({
  ...
  if (useFormData) {
    ...
    if (method === API_METHOD.PUT || method === API_METHOD.PATCH) variables._method = method;
    ...
    if (statusCode === 502) {
      if (!Cookies.get(process.env.NEXT_PUBLIC_TRY_RELOAD_KEY)) {
        Object.keys(Cookies.get()).forEach((cookieName) => {
          if (cookieName !== process.env.NEXT_PUBLIC_TRY_RELOAD_KEY) Cookies.remove(cookieName, {});
        });
