...
export default function DialogProvider({ children }: { children: React.ReactNode }) {
  ...
  const { error, success, deleted } = useSelector(
    ...
    <>
      ...
      <AlertDialog open={!!success}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>{success?.message ?? "操作成功"}</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogAction
              onClick={() => {
      ...
      <AlertDialog open={!!deleted}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => dispatch({ type: "CLEAR_API_DELETE" })}>
              取消
            </AlertDialogCancel>
            <AlertDialogAction
